const library = (function () {
  ...
  const removeBook = function (button) {
    ...
    libraryDisplay.getDisplay().textContent = "";
    libraryDisplay.displayCard();
  }
...
const libraryDisplay = (function () {
  ...
  const displayCard = function () {
    ...
    myLibrary.forEach(book => {
      ...
      dateOfPublication.textContent = "Publication Year: "
      ...
      readStatus.textContent = `Read book: ${(book.read == true)
        ? "Yes" : "Not yet"}`;
